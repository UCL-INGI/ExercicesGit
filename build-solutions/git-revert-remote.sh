...
SOL_DIR="$(realpath "${POPULATE_DIR}/../git_catastrophy_scenario_2/solutions")"
PROBLEM_DIR="$(realpath "${POPULATE_DIR}/../git_catastrophy_scenario_2/public")"
...
echo "This content is wrong" > should_not_commit.txt
git add should_not_commit.txt
...
git revert --no-edit HEAD  # Revert "Misguided commit"
git commit --amend -m "REVERT"
git push
cd --
