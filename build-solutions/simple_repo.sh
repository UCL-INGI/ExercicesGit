...
curl https://inginious.org > "${REPO_CLONE}/inginious.html"
git add "${REPO_CLONE}/inginious.html"
git commit -m "Add web page"

sed -i -e "s/Lorem ipsa/Lorem ipsum/g" "${REPO_CLONE}/text.txt"
git add "${REPO_CLONE}/text.txt"
